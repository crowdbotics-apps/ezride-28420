"""ezride_28420 URL Configuration
...
admin.site.site_header = "EZRide"
admin.site.site_title = "EZRide Admin Portal"
admin.site.index_title = "EZRide Admin"

# swagger
api_info = openapi.Info(
    title="EZRide API",
    default_version="v1",
    description="API documentation for EZRide App",
)
